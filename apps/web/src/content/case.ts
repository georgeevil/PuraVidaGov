...
export const CASE: CaseContent = {
  ...
  problem: {
    ...
    stats: [
      { label: 'Horas promedio por trámite en América Latina', value: '5,4 h', source: 'BID, «El fin del trámite eterno» (2018). Costa Rica es «el segundo mejor lugar de la región» en horas, pero cae al sexto en facilidad: sus trámites exigen más idas y venidas' },
      { label: 'Trámites que exigen más de una interacción', value: 'casi la mitad', source: 'BID (2018): el 89 % se hace en persona y el 29 % de los latinoamericanos reporta haber pagado un soborno por un servicio público' },
      { label: 'Costo de un trámite presencial frente a uno en línea', value: '20 a 42× más', source: 'BID (2018): el trámite digital cuesta entre 2,35 % y 5 % del presencial, y se resuelve un 74 % más rápido' },
  ...
  evidence: {
    ...
    items: [
      ...
      { claim: 'En América Latina un trámite toma 5,4 horas en promedio, casi la mitad exige más de una interacción, el 89 % se hace en persona y hacerlo en línea cuesta entre 20 y 42 veces menos. Solo el 7 % de los latinoamericanos hizo su último trámite en línea. Costa Rica sale bien en horas —«el segundo mejor lugar de la región»— pero cae al sexto puesto en facilidad, porque sus trámites exigen más idas y venidas; y es uno de los seis únicos países de la región que ya reportan una identidad digital nacional.', source: 'BID, «El fin del trámite eterno» (2018)', url: 'https://publications.iadb.org/es/el-fin-del-tramite-eterno-ciudadanos-burocracia-y-gobierno-digital' },

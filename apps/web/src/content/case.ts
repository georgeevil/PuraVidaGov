...
export const CASE: CaseContent = {
  ...
  evidence: {
    ...
    items: [
      ...
      { claim: 'Los países que organizan el Estado por eventos de vida coinciden en la lista: nació un hijo, falleció un familiar, compré un carro o una casa, me casé, mi hijo entra a la escuela, perdí el empleo, me jubilo. Noruega eligió siete eventos prioritarios en 2019 con un ministerio responsable de cada uno; Rusia agrupó Gosuslugi por «situaciones de vida» en 2023; Suecia puso a tres agencias en un solo sitio para el fallecimiento; Estonia ofrece la prestación familiar de oficio desde 2019, aunque su auditoría de 2024 muestra que sin ley de por medio el resto sigue siendo información. Este demo implementa doce de esos eventos.', source: 'Digdir (Noruega), Gosuslugi, efterlevandeguiden.se, Riigikontroll 2024; ver docs/research/life-events-abroad.md', url: 'https://www.regjeringen.no/en/dokumenter/one-digital-public-sector/id2653874/' },

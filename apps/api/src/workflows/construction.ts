  ...
  steps: [
    ...
    },
    {
      ...
      legal: {
        ...
        gap: 'Obligación municipal de leer del Registro Nacional por el bus en vez de pedir copias (Ley 8220 art. 2 con dientes).',
        gapEn: 'A municipal duty to read from the Registro Nacional through the bus instead of asking for copies (Ley 8220 art. 2 with teeth).',
    ...
    },
    {
      ...
      legal: {
        status: 'parcial',
        today: 'Las municipalidades conectadas a «APC Municipal» reciben el expediente aprobado y emiten el permiso en línea; el resto pide el sello de APC impreso más las certificaciones. El impuesto del 1 % (Ley 833) se paga en cada municipalidad.',
        todayEn: 'Municipalities connected to "APC Municipal" receive the approved file and issue the permit online; the rest ask for the printed APC stamp plus certificates. The 1 % tax (Ley 833) is paid at each municipality.',
      ...
      cards: [
        ...
        },
        {
          ...
          rows: [
            ...
            { label: 'Impuesto 1 % (Ley 833)', value: crc(permit.taxCrc) },
